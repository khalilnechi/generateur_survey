...
class Creation_survey extends React.Component {
    ...
    render() {
        ...
        console.log("reder=" + this.state.selected_mails)
        return (
                        ...
                        <SearchUserBox options={this.state.suggestions}
                            onChange={(value) => {
                                this.setState({
                                    ...
                                    console.log("selected_mails=" + JSON.stringify(this.state.selected_mails))

                                }
                                )
                            }}
                            defaultValue={[{"value":"assyl.elyahmadi@newaccess.ch","label":"assyl.elyahmadi@newaccess.ch"},{"value":"Sami.jrad@newaccess.ch","label":"Sami.jrad@newaccess.ch"}]}
                        />
