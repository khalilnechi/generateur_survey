                ...
                this.state.Tab_reponses.forEach((rep)=>{
                    rep.UserResponse.forEach((UserResponse,indexQuestion)=>{
                        ...
                        /*else
                         ...
                         this.state.Tab_Analyse[indexQuestion]=1*/
                        //else
