...
class Creation_survey extends React.Component {
    ...
    ajouterQuestion() {
        ...
        console.log("this.state.question\n" + JSON.stringify(this.state.table_questions))
    }
    ...
    changer_statut(key) {
        ...
        console.log("changer_statut:" + key)
        ...
        console.log("this.state.table_questions[0].obligatoire:" + this.state.table_questions[0].obligatoire)
        this.forceUpdate()
    }
                ...
                if (this.state.table_questions[i].question === "")
                    ...
                    if (this.state.table_questions[i].type_rep === "Cases à cocher" || this.state.table_questions[i].type_rep === "Choix multiple") {
                        if (this.state.table_questions[i].type_rep === "Cases à cocher") {
                            var Table_testvide = this.state.table_questions[i].CheckboxTab;
                        }
                        else
                            if (this.state.table_questions[i].type_rep === "Choix multiple") {
                                var Table_testvide = this.state.table_questions[i].radioTab;
                            }
    ...
    valider_survey() {
        ...
        if (this.TestChampsVides() === true)// true : il y a un champs vide   // false : Tous les champs ont été rempli
        {
            ...
            console.log("va")
            console.log("validation:id_sondage=" + this.state.ID)
            ...
            firebase.database().ref('nb_sondage').once('value', (snapshot) => {
                ...
                firebase.database().ref('Sondage/' + IdSondage).set({
                    ...
                    date: fullDate,
                    time: time,
                    private_viewers:this.state.private_viewers
                }).then(() => {
    ...
    componentWillMount() {
        console.log("componentWillMount:Creation_survey")
                    ...
                    if (user) {
                        ...
                        if (this.state.ID != -1) {//Modification du sondage
                            ...
                            firebase.database().ref('Sondage/' + this.state.ID).on('value', (sondage) => {
                                ...
                                console.log("sondage=" + JSON.stringify(sondage))
                                console.log("Titre=" + sondage.val().Titre)
                ...
                <div style={{ backgroundColor: "", marginTop: 20 }}>
                    ...
                    <Collapse in={this.state.Statut_sondage === "Privé"}>
                        ...
                        onChange={(value)=>{
                            ...
                            value.forEach(el=>{
                                this.setState({
                                    private_viewers:this.state.private_viewers.push(el.label)
                                }) 
                            })
                            console.log("values="+JSON.stringify(this.state.private_viewers))
                            }} />
                            ...
                            return (
                                ...
                                <Question
                                    ...
                                    onChange={(typeInput, texte) => {
                                        // console.log("typeInput=" + typeInput + "| texte:" + texte + key);
                                    ...
                                    onDelete={() => {
                                        ...
                                        this.forceUpdate()
                                        console.log("this.state.table_questions\n" + JSON.stringify(this.state.table_questions))
                                    ...
                                    onRadioAdd={() => {
                                        console.log("onRadioAdd numero " + this.state.table_questions[key].radioTab.length + " dans " + key)
                                    ...
                                    onCheckboxAdd={() => {
                                        console.log("onCheckboxAdd numero " + this.state.table_questions[key].CheckboxTab.length + " dans " + key)
