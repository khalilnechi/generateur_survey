                                ...
                                <div>

                                    {
                                        this.state.Tab_Analyse.map((Analyse, index) => {
                                            ...
                                            if (this.state.table_questions[index].type_rep=== "Zone de texte"||this.state.table_questions[index].type_rep=== "Zone de commentaire")
                                            return(
                                                <h4 key={index} style={{margin: 35 }}>
                                                    La question {index+1} est une zone de texte ou une zone de commentaire.
                                                    Veuillez la consulter en cliquant sur "Consulter les réponses"
                                                </h4>
                                            )
                                            else
                                            return (
