...
class Creation_survey extends React.Component {
    ...
    render() {
        ...
        console.log("=============>render=" + this.state.selected_mails)
        return (
                ...
                <div style={{ backgroundColor: "", marginTop: 20 }}>
                    ...
                    <Collapse in={this.state.Statut_sondage === "Privé"}>
                        <SearchUserBox options={this.state.suggestions}
                            ...
                            defaultValue={[{"value":"assyl.elyahmadi@newaccess.ch","label":"assyl.elyahmadi@newaccess.ch"},
                            {"value":"Sami.jrad@newaccess.ch","label":"Sami.jrad@newaccess.ch"}]}
                        />
